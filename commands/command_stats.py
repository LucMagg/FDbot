...
def get_stats(args, command, heroes, pets, talents, qualities, bot_commands):
	...
	if search_match == None:
		...
		if command == 'hero':
			description = format_hero(search_match, heroes, pets, talents, qualities, bot_commands)
		else:
			description = format_pet(search_match, heroes, pets, talents, bot_commands)
...
def format_hero(hero, heroes, pets, talents, qualities, bot_commands):
	#***calculs***
...
def format_pet(pet, heroes, pets, talents, bot_commands):
	#***calculs***
	other_heroes = []
	count_heroes = 0
	for hero in heroes:
